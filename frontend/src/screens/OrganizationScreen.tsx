...
const ROLE_LABELS: Record<OrgRole, { label: string; color: string }> = {
    ...
    member: { label: 'Member', color: '#16A34A' },
};
...
const styles = StyleSheet.create({
    ...
    dangerCard: { borderWidth: 1, borderColor: '#FCA5A5' },
    ...
    btnDanger: { backgroundColor: '#FEE2E2', paddingHorizontal: 10 },
    btnDangerFull: { backgroundColor: '#DC2626' },
    ...
    orgItemSelected: { backgroundColor: colors.primary + '10' },
    orgItemContent: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    orgName: { fontSize: 16, color: colors.textPrimary, fontWeight: '500' },
    ...
    emptyText: { color: colors.textMuted, fontStyle: 'italic', textAlign: 'center', paddingVertical: 16 },
    ...
    memberEmail: { fontSize: 13, color: colors.textMuted },
    roleChip: {
        paddingHorizontal: 12,
        paddingVertical: 6,
        borderRadius: 16,
    ...
    roleChipText: { fontSize: 13, color: colors.textPrimary },
