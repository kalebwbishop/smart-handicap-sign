...
input_intensity = test_intensity_true

def setup():
    print("Starting")

def loop():
    global input_intensity
    
    i = 0
    while(True):
        # TODO: Capture photoresistor values
        # print(int(test_data_false[i]))
        ...
        min_value = min(input_intensity)
        max_value = max(input_intensity)
        input_intensity = [(x - min_value) / max_value for x in input_intensity]
            
        classification = classify(input_intensity)
        
        print(classification)
        
        # TODO: Send signal to notifications api
